...
public class HighScoresWindow extends JDialog {
    ...
    public void setNoviceRecord(String winnerName, String timeValue) {
        noviceRecordLabel.setText(createRecordText(winnerName, timeValue));
    }

    public void setMediumRecord(String winnerName, String timeValue) {
        mediumRecordLabel.setText(createRecordText(winnerName, timeValue));
    }

    public void setExpertRecord(String winnerName, String timeValue) {
        expertRecordLabel.setText(createRecordText(winnerName, timeValue));
    }

    public String createRecordText(String winnerName, String timeValue) {
