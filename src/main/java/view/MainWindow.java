...
public class MainWindow extends JFrame {
    ...
    public void setCellImage(int x, int y, GameImage gameImage) {
        SwingUtilities.invokeLater(() -> cellButtons[y][x].setIcon(gameImage.getImageIcon()));
    }

    public void setBombsCount(int bombsCount) {
        SwingUtilities.invokeLater(() -> bombsCounterLabel.setText(String.valueOf(bombsCount)));
    }

    public void setTimerValue(int value) {
        SwingUtilities.invokeLater(() -> timerLabel.setText(String.valueOf(value)));
    }
